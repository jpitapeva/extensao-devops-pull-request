# Use o modelo da OpenAI ou da Azure Foundry para revisar solicitacoes de PullRequest do Azure Devops
...
- Parâmetro/endpoint 'aoi_endpoint' para agent NAO criado/construido via deploy dentro do Microsoft Azure AI Foundry: https://XXXXX.openai.azure.com/openai/v1/chat/completions.
